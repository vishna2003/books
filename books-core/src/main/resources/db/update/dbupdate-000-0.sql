...
create cached table T_COMMON_LIBRARY_BOOK (CLB_ID_C varchar(36) not null primary key,CLB_TITLE_C varchar(255) not null,CLB_AUTHORS_C varchar(1024) not null,CLB_GENRES_C varchar(1024) not null,CLB_TOTAL_RATINGS integer not null,CLB_AVERAGE_RATING DOUBLE not null);
