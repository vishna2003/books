...
import com.sismics.books.core.model.jpa.BookTag;
...
public class TagDao {
     ...
     * @param tagIdSet
     */
    public void updateTagList(String bookId, Set<String> tagIdSet) {
        // Delete old tag links
        EntityManager em = ThreadLocalContext.get().getEntityManager();
        Query q = em.createQuery("delete BookTag bt where bt.bookId = :bookId");
    ...
    /**
     * Returns tag list on a book.
     * @param bookId
     * @return
     */
    @SuppressWarnings("unchecked")
    public List<TagDto> getByBookId(String bookId) {
        EntityManager em = ThreadLocalContext.get().getEntityManager();
        ...
        sb.append(" where bt.BOT_IDBOOK_C = :bookId and t.TAG_DELETEDATE_D is null ");
    ...
    public void delete(String tagId) {
        ...
        // Delete linked data
        q = em.createQuery("delete BookTag bt where bt.tagId = :tagId");
        q.setParameter("tagId", tagId);
        q.executeUpdate();
    }
