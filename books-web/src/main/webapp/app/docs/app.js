...
.config(function($stateProvider, $httpProvider, RestangularProvider) {
  ...
  .state('main', {
    ...
    views: {
      'page': {
        templateUrl: 'partial/books/main.html',
        controller: 'Main'
      }
    }
  })
  .state('tag', {
    ...
    views: {
      'page': {
        templateUrl: 'partial/books/tag.html',
        controller: 'Tag'
      }
    }
  })
  .state('settings', {
    ...
    views: {
      'page': {
        templateUrl: 'partial/books/settings.html',
        controller: 'Settings'
      }
    }
  })
    .state('settings.default', {
      ...
      views: {
        'settings': {
          templateUrl: 'partial/books/settings.default.html',
    ...
    .state('settings.account', {
      ...
      views: {
        'settings': {
          templateUrl: 'partial/books/settings.account.html',
    ...
    .state('settings.session', {
      ...
      views: {
        'settings': {
          templateUrl: 'partial/books/settings.session.html',
    ...
    .state('settings.log', {
      ...
      views: {
        'settings': {
          templateUrl: 'partial/books/settings.log.html',
    ...
    .state('settings.user', {
      ...
      views: {
        'settings': {
          templateUrl: 'partial/books/settings.user.html',
      ...
      .state('settings.user.edit', {
        ...
        views: {
          'user': {
            templateUrl: 'partial/books/settings.user.edit.html',
  ...
  .state('document', {
    ...
    views: {
      'page': {
        templateUrl: 'partial/books/document.html',
        controller: 'Document'
      }
    }
  })
    .state('document.default', {
      ...
      views: {
        'document': {
          templateUrl: 'partial/books/document.default.html',
    ...
    .state('document.add', {
      ...
      views: {
        'document': {
          templateUrl: 'partial/books/document.edit.html',
    ...
    .state('document.view', {
      ...
      views: {
        'document': {
          templateUrl: 'partial/books/document.view.html',
  ...
  .state('login', {
    ...
    views: {
      'page': {
        templateUrl: 'partial/books/login.html',
        controller: 'Login'
      }
    }
  });
